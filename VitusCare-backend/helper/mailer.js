...
dotenv.config()
const CREDENTIALS_PATH =  './credentials.json'; // service account file
...
<![endif]-->
  ...
  try {
    ...
    await sheets.spreadsheets.values.append({
      ...
      valueInputOption: 'RAW',
      resource: {
        values: [[name, email, phone, hospital, state, city, description, new Date().toISOString()]]
      }
    });
...
<![endif]-->
  ...
  try {
    ...
    await sheets.spreadsheets.values.append({
      ...
      valueInputOption: 'RAW',
      resource: {
        values: [[name, email, contactNumber, JSON.stringify(ratings),  suggestions,mrId, new Date().toISOString()]]
      }
    });
...
<![endif]-->
  ...
  try {
    ...
    await sheets.spreadsheets.values.append({
      ...
      valueInputOption: 'RAW',
      resource: {
        values: [[state, city, hospital, name, phone, email, dialysisCount, new Date().toISOString()]]
      }
    });

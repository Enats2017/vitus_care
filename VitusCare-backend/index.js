...
const allowedOrigins = ['http://localhost:3000', 'http://localhost:3001', 'http://localhost:7000', 'https://myproductiondomain.com', 'http://3.6.126.15', 'http://3.6.126.15:3000', 'https://www.vituscare.com'];
app.use(cors({

...
export default function DoctorPartnership({ onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${BASE_URL}/api/doctor-partnership`, {
        method: "POST",
        headers: {
    ...
    <form action="#" className="row" onSubmit={handleSubmit}>
      ...
      <div className="col-lg-6">
        ...
        >
          ...
          <option value="DNB/DM Nephrology">DNB/DM Nephrology</option>
      ...
      {/* Submit Button */}
      <div className="col-lg-12" style={{ marginBottom: "33px" }}>

...
class __TwigTemplate_995fab5bf0e7c7715001a7835a82b3b8 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
  ...
  <div class=\"col-sm-10\">
    <input type=\"file\" name=\"image_to_be_show\" id=\"input-image\" class=\"form-control\" />
    <!-- Hidden input to keep default value -->
    <input type=\"hidden\" id=\"default-image\" value=\"";
        // line 66
  ...
  document.addEventListener(\"DOMContentLoaded\", function () {
    ...
    inputFile.form.addEventListener(\"submit\", function (e) {
      if (!inputFile.value) {
        // If no file is selected, create a hidden input to pass default value
        let hiddenInput = document.createElement(\"input\");
        hiddenInput.type = \"hidden\";
        hiddenInput.name = inputFile.name;
        hiddenInput.value = defaultImage;
        inputFile.form.appendChild(hiddenInput);
      }
    });
  });
</script>
...
";
    ...
    {
        return array (  224 => 120,  171 => 74,  166 => 72,  157 => 66,  145 => 57,  134 => 49,  124 => 42,  114 => 35,  109 => 33,  103 => 30,  99 => 28,  92 => 24,  89 => 23,  87 => 22,  81 => 18,  70 => 16,  66 => 15,  61 => 13,  52 => 9,  46 => 6,  37 => 1,);
    }

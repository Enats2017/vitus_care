...
class __TwigTemplate_e1ed3f94caab6f1a1bff9c20773c258e extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["dashboard_1"]) {
                // line 25
                echo "      ";
                $context["class"] = twig_sprintf("col-lg-%s %s", twig_get_attribute($this->env, $this->source, $context["dashboard_1"], "width", [], "any", false, false, false, 25), "col-md-3 col-sm-6");
                // line 26
                echo "      ";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($context["row"]);
                foreach ($context['_seq'] as $context["_key"] => $context["dashboard_2"]) {
                    ...
                    if ((twig_get_attribute($this->env, $this->source, $context["dashboard_2"], "width", [], "any", false, false, false, 27) > 3)) {
                        // line 28
                        echo "      ";
                        $context["class"] = twig_sprintf("col-lg-%s %s", twig_get_attribute($this->env, $this->source, $context["dashboard_1"], "width", [], "any", false, false, false, 28), "col-md-12 col-sm-12");
                        // line 29
                        echo "      ";
                    }
                    // line 30
...
";
    ...
    {
        return array (  179 => 60,  154 => 38,  147 => 34,  144 => 33,  137 => 32,  126 => 31,  120 => 30,  117 => 29,  114 => 28,  111 => 27,  106 => 26,  103 => 25,  98 => 24,  93 => 23,  88 => 21,  84 => 19,  82 => 18,  77 => 15,  66 => 13,  62 => 12,  57 => 10,  49 => 7,  41 => 2,  37 => 1,);
    }

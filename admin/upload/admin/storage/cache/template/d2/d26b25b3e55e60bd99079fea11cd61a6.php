...
class __TwigTemplate_9533556b6c576c151391698f5d123ffd extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
  ...
  <div class=\"container-fluid\">
    ...
    <div class=\"col-sm-10\">
        ...
        <?php if (!empty(\$image_to_be_show)): ?>
            <div style=\"margin-top:10px;\">
                <p>Current Image:</p>
                <img src=\"catalog/<?php echo htmlspecialchars(\$image_to_be_show); ?>\" alt=\"Current Image\" width=\"150\">
            </div>
            <!-- Hidden input to keep old image if user doesn’t upload new one -->
            <input type=\"hidden\" name=\"old_image\" value=\"<?php echo htmlspecialchars(\$image_to_be_show); ?>\">
        <?php endif; ?>
    </div>
</div>
...
";
    ...
    {
        return array (  212 => 111,  176 => 82,  171 => 80,  145 => 57,  134 => 49,  124 => 42,  114 => 35,  109 => 33,  103 => 30,  99 => 28,  92 => 24,  89 => 23,  87 => 22,  81 => 18,  70 => 16,  66 => 15,  61 => 13,  52 => 9,  46 => 6,  37 => 1,);
    }

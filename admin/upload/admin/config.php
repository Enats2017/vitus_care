<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/vitus_care/admin/upload/admin/');
define('HTTP_CATALOG', 'http://localhost/vitus_care/admin/upload/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/vitus_care/admin/upload/admin/');
define('HTTPS_CATALOG', 'http://localhost/vitus_care/admin/upload/');

...
class __TwigTemplate_848077c5ed7de0c6b9f6c03b189c4183 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
  ...
  <div class=\"col-sm-10\">
    ...
    <input type=\"file\" name=\"image_to_be_show\" id=\"input-image\" class=\"form-control\" accept=\"image/*\" />

    <!-- Display current image if it exists -->
    ";
        // line 67
        if (($context["image_to_be_show"] ?? null)) {
            // line 68
            echo "      <div class=\"mt-2\">
        <p>Current Hero Image:</p>
        <img src=\"http://localhost/upload/image/";
            // line 70
            echo ($context["image_to_be_show"] ?? null);
            echo "\" alt=\"Current hero image\" style=\"max-width:200px; max-height:200px;\" id=\"current-image\" />
        <!-- Optional: Button to clear current image -->
        <button type=\"button\" class=\"btn btn-danger btn-sm mt-2\" onclick=\"clearCurrentImage()\">Remove Current Image</button>
      </div>
    ";
        }
        // line 75
    ...
    <div class=\"mt-2\" id=\"image-preview\" style=\"display: none;\">
      <p>Newly Selected Image Preview:</p>
      <img id=\"preview-image\" alt=\"New image preview\" style=\"max-width:200px; max-height:200px;\" />
    </div>
  </div>
</div>
...
";
    ...
    {
        return array (  227 => 118,  191 => 89,  186 => 87,  172 => 75,  164 => 70,  160 => 68,  158 => 67,  145 => 57,  134 => 49,  124 => 42,  114 => 35,  109 => 33,  103 => 30,  99 => 28,  92 => 24,  89 => 23,  87 => 22,  81 => 18,  70 => 16,  66 => 15,  61 => 13,  52 => 9,  46 => 6,  37 => 1,);
    }

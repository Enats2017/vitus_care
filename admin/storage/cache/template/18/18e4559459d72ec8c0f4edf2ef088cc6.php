...
class __TwigTemplate_93a351d7a6e68112d9e102689e6ef2ed extends Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "                  <tr>
                    <td class=\"text-center\">";
                // line 97
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["product"], "product_id", [], "any", false, false, false, 97), ($context["selected"] ?? null))) {
                    // line 98
